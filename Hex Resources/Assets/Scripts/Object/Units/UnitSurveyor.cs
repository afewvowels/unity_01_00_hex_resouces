...
public class UnitSurveyor : HexUnit
{
	...
	public void BuildAtResource(BuildingBaseClass building, HexCell resourceLocation)
	{
		...
		{
			Debug.Log("error with surveyor building at resource");
		}
	}
	...
	public IEnumerator ConstructResourceBuilding(BuildingBaseClass building, HexCell resourceLocation)
	{
		...
		if (building != null)
		{
			...
			for (float t = 0.0f; t < 1.0f; t += Time.deltaTime)
			{
				...
				{
					Debug.Log("error lerping beacon to destination");
				}
				yield return null;
			}
		}
		...
		{
			Debug.Log("error doing column attachment");
		}
		...
		{
			Debug.Log("error doing final placement on harmonic resonator");
		}
		...
		{
			Debug.Log("error doing final placement on survey beacon");
		}
	}
	...
	public void TravelToResource(List<HexCell> path, float speed, BuildingBaseClass building, HexCell resourceLocation)
	{
		...
		{
			Debug.Log("error surveyor travelling to resource");
		}
	}
	...
	public IEnumerator PlaceBeacon(BuildingBaseClass building, HexCell resourceLocation)
	{
		...
		{
			Debug.Log("error starting construct resource building coroutine");
		}
		IsBusy = false;
	}
}
