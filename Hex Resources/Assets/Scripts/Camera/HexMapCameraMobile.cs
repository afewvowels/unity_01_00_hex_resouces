...
public class HexMapCameraMobile : MonoBehaviour
{
    ...
    static HexMapCameraMobile instance;
    ...
    {
        rotationAngle += delta * rotationSpeed * Time.deltaTime * -1.0f;
    ...
    public static void ValidatePosition()
    {
        ...
        float posX = grid.GetSizeX();
        float posZ = grid.GetSizeZ();
